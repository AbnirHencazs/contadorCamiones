...
//Variables
char            auxS[12] = {0}, auxB[12] = {0}, auxP[12] = {0}, auxBloq[12] = {0}, auxT[12] = {0};
...
bool            permanencia = false, empiezaEntrada = false, empiezaSalida = false;
...
short entrando(short estado){
 if(estado == ENTRANDO){
  ...
  if( ((!SENSOR2 & !SENSOR4) & ((!SENSOR1 & !SENSOR3) | (!SENSOR3 & !SENSOR5) | (!SENSOR1 &  !SENSOR5))) | ((!SENSOR4 & !SENSOR6) & ((!SENSOR1 & !SENSOR3) | (!SENSOR3 & !SENSOR5) | (!SENSOR1 & !SENSOR5))) | ((!SENSOR2 & !SENSOR6) & ((!SENSOR1 & !SENSOR3) | (!SENSOR3 & !SENSOR5) | (!SENSOR1 & !SENSOR5)))
  /*PASADO((!SENSOR2 & !SENSOR4) & ((!SENSOR1 | !SENSOR3) & (!SENSOR3 | !SENSOR5))) | ((!SENSOR4 & !SENSOR6) & ((!SENSOR1 | !SENSOR3) & (!SENSOR3 | !SENSOR5))) | ((!SENSOR2 & !SENSOR6) & ((!SENSOR1 | !SENSOR3) & (!SENSOR3 | !SENSOR5)))*/
  /*((!SENSOR2 & !SENSOR4) & (!SENSOR1 | !SENSOR3 | !SENSOR5)) | ((!SENSOR4 & !SENSOR6) & (!SENSOR1 | !SENSOR3 | !SENSOR5)) | ((!SENSOR2 & !SENSOR6) & (!SENSOR1 | !SENSOR3 | !SENSOR5))*/
     ){
   lcd_cmd(_LCD_CLEAR);
...
short transicionE(short estado){
 if(estado == TRANSICION){
  ...
  comienzaContarAtasco = true;
  if(cuentaAtasco >= 1){
    comienzaContarAtasco = false;
    cuentaAtasco = 0;
    //empiezaEntrada = false;
    //permanencia = false;
    return debugEstado = ESPERA;
  ...
  ((SENSOR1) & ((!SENSOR2 & !SENSOR4) | (!SENSOR4 & !SENSOR6) | (!SENSOR2 &  !SENSOR6))) | ((SENSOR3 ) & ((!SENSOR2 & !SENSOR4) | (!SENSOR4 & !SENSOR6) | (!SENSOR2 & !SENSOR6))) | ((SENSOR5) & ((!SENSOR2 & !SENSOR4) | (!SENSOR4 & !SENSOR6) | (!SENSOR2 & !SENSOR6)))
  /*PASADO((SENSOR1 | SENSOR3) | ((!SENSOR2 | !SENSOR4) & (!SENSOR4 | !SENSOR6)) ) | ( (SENSOR3 | SENSOR5) & ((!SENSOR2 | !SENSOR4) & (!SENSOR4 | !SENSOR6)) ) | ( (SENSOR1 | SENSOR5) & ( ((!SENSOR2 | !SENSOR4) & (!SENSOR4 | !SENSOR6)) ) )*/
  /*( (SENSOR1 & SENSOR3) & (!SENSOR2 | !SENSOR4 | !SENSOR6) ) | ( (SENSOR3 & SENSOR5) & (!SENSOR2 | !SENSOR4 | !SENSOR6) ) | ( (SENSOR1 & SENSOR5) & (!SENSOR2 | !SENSOR4 | !SENSOR6) )*/
  /*(SENSOR1 & SENSOR3 & SENSOR5)& (!SENSOR2 & SENSOR4) ) | ( (SENSOR1 & SENSOR3 & SENSOR5)& (!SENSOR4 & SENSOR6) ) | ( (SENSOR1 & SENSOR3 & SENSOR5) & (!SENSOR2 & SENSOR6) )*/ ){
   lcd_cmd(_LCD_CLEAR);
   return debugEstado = TRANENT;
   }
  if( 
  /*(SENSOR2 | SENSOR4 | SENSOR6 | SENSOR1 | SENSOR3 | SENSOR5)*/
  /*(SENSOR2 & SENSOR4 & SENSOR6 & !SENSOR1) | (SENSOR2 & SENSOR4 & SENSOR6 & !SENSOR3) | (SENSOR2 & SENSOR4 & SENSOR6 & !SENSOR5)*/
     (!SENSOR1 & !SENSOR3) | (!SENSOR3 & !SENSOR5) | (!SENSOR1 & !SENSOR5)
    /*(!SENSOR1 & !SENSOR3 &!SENSOR5)*/
    ){
   lcd_cmd(_LCD_CLEAR);
...
short saliendo(short estado){
 if(estado == SALIENDO){
  ...
  if( ((!SENSOR1 & !SENSOR3) & ((!SENSOR2 & !SENSOR4) | (!SENSOR4 & !SENSOR6) | (!SENSOR2 & !SENSOR6))) | ((!SENSOR3 & !SENSOR5) & ((!SENSOR2 & !SENSOR4) | (!SENSOR4 & !SENSOR6) | (!SENSOR2 & !SENSOR6))) | ((!SENSOR1 & !SENSOR5) & ((!SENSOR2 & !SENSOR4) | (!SENSOR4 & !SENSOR6) | (!SENSOR2 & !SENSOR6)))
      /*((!SENSOR1 & !SENSOR3) & ((!SENSOR2 | !SENSOR4) & (!SENSOR4 | !SENSOR6) & (!SENSOR2 | !SENSOR6))) | ((!SENSOR3 & !SENSOR5) & ((!SENSOR2 | !SENSOR4) & (!SENSOR4 | !SENSOR6) & (!SENSOR2 & !SENSOR6))) | ((!SENSOR1 & !SENSOR5) & ((!SENSOR2 | !SENSOR4) & (!SENSOR4 | !SENSOR6) & (!SENSOR2 & !SENSOR6)))*/
      /*PASADO((!SENSOR1 & !SENSOR3) & ((!SENSOR2 | !SENSOR4) & (!SENSOR4 | !SENSOR6))) | ((!SENSOR3 & !SENSOR5) & ((!SENSOR2 | !SENSOR4) & (!SENSOR4 | !SENSOR6))) | ((!SENSOR1 & !SENSOR5) & ((!SENSOR2 | !SENSOR4) & (!SENSOR4 | !SENSOR6)))*/
      /*((!SENSOR1 & !SENSOR3) & (!SENSOR2 | !SENSOR4 | !SENSOR6)) | ((!SENSOR3 & !SENSOR5) & (!SENSOR2 | !SENSOR4 | !SENSOR6)) | ((!SENSOR1 & !SENSOR5) & (!SENSOR2 | !SENSOR4 | !SENSOR6))*/
    ){
   lcd_cmd(_LCD_CLEAR);
...
short transicionS(short estado){
 if(estado == TRANSICIONS){
  ...
  if( /*( (SENSOR2 & SENSOR4) & ((!SENSOR1 & !SENSOR3) | (!SENSOR3 & !SENSOR5) | (!SENSOR1 & !SENSOR5)) ) | ( (SENSOR4 & SENSOR6) & ((!SENSOR1 & !SENSOR3) | (!SENSOR3 & !SENSOR5) | (!SENSOR1 & !SENSOR5)) ) | ( (SENSOR2 & SENSOR6) & ((!SENSOR1 & !SENSOR3) | (!SENSOR3 & !SENSOR5) | (!SENSOR1 & !SENSOR5)) )*/
  /*(SENSOR2 & SENSOR4) & (!SENSOR1 | !SENSOR3 | !SENSOR5) ) | ( (SENSOR4 & SENSOR6) & (!SENSOR3 | !SENSOR5 | !SENSOR1) ) | ( (SENSOR2 & SENSOR6) & (!SENSOR1 | !SENSOR5 | !SENSOR3) )*/
  ((SENSOR2) & ((!SENSOR1 & !SENSOR3) | (!SENSOR3 & !SENSOR5) | (!SENSOR1 &  !SENSOR5))) | ((SENSOR4) & ((!SENSOR1 & !SENSOR3) | (!SENSOR3 & !SENSOR5) | (!SENSOR1 & !SENSOR5))) | ((SENSOR6) & ((!SENSOR1 & !SENSOR3) | (!SENSOR3 & !SENSOR5) | (!SENSOR1 & !SENSOR5)))
  /*( (SENSOR2 & SENSOR4 & SENSOR6)& (!SENSOR1 & SENSOR3) ) | ( (SENSOR2 & SENSOR4 & SENSOR6)& (!SENSOR3 & SENSOR5) ) | ( (SENSOR2 & SENSOR4 & SENSOR6) & (!SENSOR3 & SENSOR5) )*/ ){
   lcd_cmd(_LCD_CLEAR);
   return debugEstado = TRANSAL;
   }
  if( /*(!SENSOR2 & !SENSOR4 & !SENSOR6)*/
  (!SENSOR2 & !SENSOR4) | (!SENSOR4 & !SENSOR6) | (!SENSOR2 & !SENSOR6)
  /*PASADO(SENSOR1 | SENSOR3 | SENSOR5 | SENSOR2 | SENSOR4 | SENSOR6)*/
  /*((SENSOR1 | SENSOR3) & (!SENSOR2 | !SENSOR4 | !SENSOR6)) | ((SENSOR3 | SENSOR5) & (!SENSOR2 | !SENSOR4 | !SENSOR6)) | ((SENSOR5 | SENSOR1) & (!SENSOR2 | !SENSOR4 | !SENSOR6))*/
  /*(SENSOR1 & SENSOR3 & SENSOR5 & !SENSOR2) | (SENSOR1 & SENSOR3 & SENSOR5 & !SENSOR4) | (SENSOR1 & SENSOR3 & SENSOR5 & !SENSOR6)*/
    ){
   lcd_cmd(_LCD_CLEAR);
   return debugEstado = SALIENDO;
   }
...
short transicionSal(short estado){
 if(estado == TRANSAL){
  ...
  comienzaContarAtasco = true;
   if( (!SENSOR2 & !SENSOR4) | (!SENSOR4 & !SENSOR6) | (!SENSOR2 & !SENSOR6)
   /*PASADO!SENSOR2 | !SENSOR4 | !SENSOR6*/
     ){
    lcd_cmd(_LCD_CLEAR);
    return debugEstado =TRANSICIONS;
    }
